...
<div class="btn-group">
  ...
  <a class="btn btn-warning" href='./test.php?cid=<?php echo $cid?>'><i class="icon-question-sign"></i><?php echo $MSG_PROBLEMS?></a>
  <a class="btn btn-success" href='./status.php?cid=<?php echo $cid?>'><i class="icon-check"></i><?php echo $MSG_STATUS?></a>
  <a class="btn btn-danger" href='./testrank.php?cid=<?php echo $cid?>'><i class="icon-signal"></i><?php echo $MSG_STANDING?></a>
  <a class="btn btn-inverse" href='./teststatistics.php?cid=<?php echo $cid?>'><i class="icon-info-sign"></i><?php echo $MSG_STATISTICS?></a>
</div>
