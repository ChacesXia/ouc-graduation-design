...
<tr bgcolor=#D7EBFF><td width=15%><?php echo $MSG_Number?><td width=25% align=center><?php echo $Rank?><td width=70% align=center>已经完成的题目列表</tr>
...
//}
echo "<tr id=pie bgcolor=#D7EBFF><td>饼图显示<td><div id='PieDiv' style='position:relative;height:105px;width:120px;'></div></tr>";
...
<tr bgcolor=#D7EBFF><td>学校:<td align=center><?php echo $school?></tr>
<tr bgcolor=#D7EBFF><td>邮箱地址:<td align=center><?php echo $email?></tr>
</table>
<?php
