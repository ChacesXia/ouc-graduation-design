...
?>
      ...
      <nav class="navbar navbar-default" role="navigation" >
        ...
        <li <?php if ($url=="faqs.php") echo " $ACTIVE";?>><a href="<?php echo $path_fix?>faqs.php"><?php echo $MSG_FAQ?></a></li>
              ...
              <li <?php if ($url=="test.php") echo " $ACTIVE";?>><a href="<?php echo $path_fix?>test.php"><?php echo $MSG_test?></a></li>
<?php if(isset($_GET['cid'])){
  $cid=intval($_GET['cid']);
?>
        <li><a>[</a></li>
              <li class="active" ><a href="<?php echo $path_fix?>test.php?cid=<?php echo $cid?>">
      <?php echo $MSG_PROBLEMS?>
        </a></li>
               <li  class="active" ><a href="<?php echo $path_fix?>status.php?cid=<?php echo $cid?>">
      <?php echo $MSG_STATUS?>
        </a></li>
              <li  class="active" ><a href="<?php echo $path_fix?>testrank.php?cid=<?php echo $cid?>">
      <?php echo $MSG_RANKLIST?>
        </a></li>
              <!--<li  class="active" ><a href="<?php echo $path_fix?>testrank-oi.php?cid=<?php echo $cid?>">
      OI<?php echo $MSG_RANKLIST?>
        </a></li>-->
              <li  class="active" ><a href="<?php echo $path_fix?>teststatistics.php?cid=<?php echo $cid?>">
      <?php echo $MSG_STATISTICS?>
        </a></li>
        <li><a>]</a></li>
<?php }?>
              <li <?php if ($url=="recent-test.php") echo " $ACTIVE";?>><a href="<?php echo $path_fix?>recent-test.php"><?php echo $MSG_RECENT_test?></a></li>
              <!--<li class="dropdown">
