...
<?php echo $MSG_PROBLEM_ID?>:<input type=text size=4 name=problem_id value='<?php echo htmlentities($problem_id,ENT_QUOTES,'UTF-8')?>'>
<?php echo $MSG_USER?>:<input type=text size=4 name=user_id value='<?php echo htmlentities($user_id,ENT_QUOTES,'UTF-8')?>'>
